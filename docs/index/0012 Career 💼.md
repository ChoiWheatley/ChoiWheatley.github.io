...
- [[병합정렬 중 병합파트에서 임시 메모리를 사용하지 않고 문제를 해결하는 방법에 대해 설명해주세요]]

### 객체지향 관련 면접질문

- [[array와 list의 차이점을 설명해주세요 자바의관점으로]]
- [[MVC, MVP, MVVM 패턴에 대하여 설명해주세요]]
...
- [[개발 직무를 선택하신 계기가 있나요 개발자로서 목표는 무엇인가요]]
- [[개발자로서 가장 잘 구현할 수 있는 기능이 무엇입니까]]
- [[세상의 어떤 문제를 해결하고 싶으세요 어떤 직무로서 해결하고 싶으세요 어떻게 해결하고 싶으세요]]
- [[가장 열정을 가지고 임했던 프로젝트(목표나 과제)를 소개해주시고, 해당 프로젝트의 수행 과정 및 결과에 대해 설명해주세요]]
